This dsl workflow implements a DSL workflow. In this sample, we provide sample yaml files each defines a custom workflow that can be processed by this dsl workflow sample code.
